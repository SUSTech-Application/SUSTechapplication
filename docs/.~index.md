...
- 投稿/修改请联系 **12313635 AT mail.sustech.edu.cn**  或 **zhangwy2022 AT
  mail.sustech.edu.cn** 或 **zhangyj2021 AT mail.sustech.edu.cn**
...
1. 对于没有Git使用背景的大部分同学：请将编辑好的`Word`/`Pages`/`Markdown`文件发送**zhangyj2021 AT mail.sustech.edu.cn** 或者 **zhangwy2022 AT
