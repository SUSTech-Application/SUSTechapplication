...
通常北美PhD的面试就只有面试（时长半小时），但是我遇到了非常少见的情况，老师让我在规定时间内写代码还要我写三页的research
...
**注：可参考阎相易学长写的这个[表格](/oversea-program/summer-research/importance_of_summer_research_in_CS_yanxiangyi)（在这篇文章的最下面）**
...
注：也可参考阎相易学长写的[这篇文章](/oversea-program/summer-research/importance_of_summer_research_in_CS_yanxiangyi)
